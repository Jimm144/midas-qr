...
export function initDOM(root = document) {
  ...
  Object.assign(DOM, {
    ...
    complexitySelect: byId("complexity-select"),
    ...
    mediumColorFg: byId("medium-color-fg"),
    colorFgMediumText: byId("color-fg-medium-text"),
    ...
    mediumParameters: byId("medium-parameters"),
    qrSizeMedium: byId("qr-size-medium"),
    ...
    mediumLogoOptions: byId("medium-logo-options"),
    logoSizeMedium: byId("logo-size-medium"),
